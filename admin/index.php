...
$resNotifikasi = mysqli_query($conn, "SELECT * FROM notification WHERE target='0' ORDER BY type ASC");
$resUser = mysqli_query($conn, "SELECT * FROM admin WHERE id='$adminID'");
...
<div class="page-container"><!-- add class "sidebar-collapsed" to close sidebar by default, "chat-visible" to make chat appear always -->
	...
	<?php include('../config/nav_admin.php'); ?>
